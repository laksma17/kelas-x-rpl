    ...
    <div class="container">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="float-end mt-4 mr-4">User: <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?> &nbsp</a></div>
                <div class="float-end mt-4 mr-4">Level: <?php echo $_SESSION['level'] ?> &nbsp </div>
